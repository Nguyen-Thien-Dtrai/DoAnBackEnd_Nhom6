            ...
            <div class="container">
                ...
                <div class="sreach float-right">
                    <form action="./cake.php" method="get" style="float:right!important;margin:9px;">
                        <input type="text" name="keyword" placeholder="Gõ bánh cần tìm...">
                        <input type="submit" name="submit" value="Tìm" class="btn btn-outline-danger">
                    </form>
                </div>
            </div>
        </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav justify-content-end">
                            ...
                            <li class="dropdown submenu">
                                <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#">Mẫu bánh &#9660;</a>
                            ...
                            <li class="dropdown submenu">
                                <a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" href="#">Loại bánh &#9660;</a>
                                <ul class="dropdown-menu">
                                    <?php
